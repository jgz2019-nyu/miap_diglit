...
## Summary 
The `chown` command allows you to . Also known as `change owner', is a command-line shell command used to change the owner of a file or directory. The cd command takes an argument, usually the name of the folder you want to move to. `cd` is frequently included built directly into a command-line interpreter.
